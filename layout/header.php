            ...
            <nav class="navbar navbar-default">
              <div class="container-fluid">
                ...
                <div class="navbar-header">
                  ...
                  <a class="navbar-brand" href="#"><img src="<?php echo EMC_PARENT_DIR; ?>assets/img/logo_fr.png" /></a>
                </div>
                ...
                ?>
                 <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
                  <ul class="nav navbar-nav">
                    <li class="<?php if ("index.php" == $slug) echo "active"; ?>"><a href="<?php echo EMC_PARENT_DIR; ?>index.php">Home <span class="sr-only">(current)</span></a></li>
                    <li class="dropdown">
                      ...
                      <ul class="dropdown-menu">
                        <li class="<?php if ("get_cotation.php" == $slug) echo "active"; ?>">
                            <a href="<?php echo EMC_PARENT_DIR; ?>samples/get_cotation.php">Paris to Bordeaux</a>
                        </li>
                        <li class="<?php if ("make_order_inter.php" == $slug) echo "active"; ?>">
                    ...
                    <li class="dropdown">
                      ...
                      <ul class="dropdown-menu">
                        <li class="<?php if ("make_order.php" == $slug) echo "active"; ?>">
                            <a href="<?php echo EMC_PARENT_DIR; ?>samples/make_order.php">Marseille to Paris (domestic)</a>
                        </li>
                        <li class="<?php if ("make_order_with_insurance.php" == $slug) echo "active"; ?>">
                            <a href="<?php echo EMC_PARENT_DIR; ?>samples/make_order_with_insurance.php">Marseille to Paris with insurance (domestic)</a>
                        </li>
                        <li class="<?php if ("make_order_inter.php" == $slug) echo "active"; ?>">
                            <a href="<?php echo EMC_PARENT_DIR; ?>samples/make_order.php?dest=Sydney">Paris to Sydney (international)</a>
                        </li>
                        <li class="<?php if ("get_status.php" == $slug) echo "active"; ?>">
                    ...
                    <li class="dropdown">
                      ...
                      <ul class="dropdown-menu">
                        <li class="<?php if ("get_list_parcel_points.php" == $slug) echo "active"; ?>">
                            <a href="<?php echo EMC_PARENT_DIR; ?>samples/get_list_parcel_points.php">Next to a given postcode</a>
                        </li>
                        <li class="<?php if ("get_parcel_point.php" == $slug) echo "active"; ?>">
                    ...
                    <li class="dropdown">
                      ...
                      <ul class="dropdown-menu">
                        ...
                        <li class="">
                            <a href="<?php echo EMC_PARENT_DIR; ?>samples/get_user.php">User info</a>
                        </li>
                      </ul>
                    </li>
